...
namespace CapaPresentacionTienda.Controllers
{
    public class TiendaController : Controller
    {
        ...
        public async Task<JsonResult> ProcesarPago(List<Carrito> oListaCarrito, Venta oVenta)
        {
            ...
            detalle_venta.Locale = new CultureInfo("es-ES");
            ...
            foreach(Carrito oCarrito in oListaCarrito)
            {
                ...
                oListaItem.Add(new Item() { 
                    ...
                    {
                        currency_code = "EUR",
                        value = oCarrito.oProducto.Precio.ToString("0.00", CultureInfo.InvariantCulture)
                    }
                });
            ...
            PurchaseUnit purchaseUnit = new PurchaseUnit()
            {
                ...
                description="compra de articulo de Amazoom",
                items= oListaItem
            };
            ...
            Checkout_Order oCheckoutOrder = new Checkout_Order()
            {
                ...
                {
                    brand_name="Amazoom.com",
                    landing_page="NO_PREFERENCE",
                    user_action="PAY_NOW",
                    return_url= "https://localhost:44329/Tienda/PagoEfectuado",
                    cancel_url= "https://localhost:44329/Tienda/Carrito"
                }
            };
