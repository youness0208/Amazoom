...
namespace NovaMarket.Controllers
{
    ...
    public class MantenedorController : Controller
    {
        ...
        public JsonResult GuardarProducto(string objeto, HttpPostedFileBase archivoImagen)
        {
            ...
            decimal precio;
            if (decimal.TryParse(oProducto.PrecioTexto,NumberStyles.Number, new CultureInfo("es-ES"), out precio))
            {
                oProducto.Precio = precio;
            }
            else
            {
                return Json(new { operacion_exitosa = false, mensaje = "El formate del precio debe ser ##,##" }, JsonRequestBehavior.AllowGet);
            }
